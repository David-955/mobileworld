...
class PdfGenerator
{
    public function generateFacture(array $commandes): string
    {
        // Initialiser FPDF
        $pdf = new Fpdi();
        ...
        // Ajouter le logo, webp n'est pas supporté
        ...
        $pdf->Cell(0, 10, 'Date : ' . $commandes[0]->getDate()->format('d/m/Y H:i:s'), 0, 1);
        $pdf->Ln(10);
